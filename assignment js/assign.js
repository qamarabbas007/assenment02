...
//                           <---Question--->
//Write a javascript function which will take an array of number stored and find 
...
//   var rewrite=str.split("").reverse().join("");
//   //return str.toLowerCase()=== rewrite.toLowerCase();
//   if(str.toLowerCase()===rewrite.toLowerCase()){
//     console.log(str+"  is a plaindrom");
//   }
//   else{
...
//   slowLoris.innerHTML="<h1>This is the new tag</h1> ";
//   //slowLoris.className +=" hidden";
//   slowLoris.style.color="green";
//   slowLoris.style.backgroundColor="red";
// }

// function run() {
//   var p = document.getElementsByTagName("p");
//   p[1].innerHTML ="<h1>This is the new tag</h1>";
//    console.log(p);
